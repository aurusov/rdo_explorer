...
$Sequence  R_W_Fun:such_as Transaction.Act 
...
$Function Pr_hst: such_as Con_1
$Type = algorithmic
$Parameters
	Par:	integer[1..6]
$Body
  Calculate_if  Par = 1  Pr_hst = Hst1
  Calculate_if  Par = 2  Pr_hst = Hst2
  Calculate_if  Par = 3  Pr_hst = Hst3
  Calculate_if  Par = 4  Pr_hst = Hst4
  Calculate_if  Par = 5  Pr_hst = Hst5
  Calculate_if  Par = 6  Pr_hst = Hst6
$End

$Function Kin_hst: such_as Con_1
$Type = algorithmic
$Parameters
	Par:	integer[1..6]
$Body
...
$Function Ccn : such_as SubQ.Con
$Type = algorithmic
$Parameters
	Par1:integer[0..1]
	Par2:such_as SubQ.Con
	Par3:such_as SubQ.Con
$Body
...
$Function Cmt1 : such_as Transaction.Act
$Type = algorithmic
$Parameters
	Par1: such_as Counter.Who 
$Body
...
$Type = algorithmic
$Parameters
	Par1: such_as Transaction.Act 
	Par2: such_as Transaction.Act 
$Body
